        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              <strong className="text-destructive"> Your business is invisible in the searches that matter most.</strong>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center p-8 card-enhanced hover:shadow-glow transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-destructive/10 to-destructive/5 rounded-2xl p-8 md:p-12 border-l-4 border-destructive">
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
              Every Day You Wait, Your Competitors Gain Ground
            </h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-semibold text-foreground mb-4">What's Happening Right Now:</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-foreground mb-4">The Cost of Delay:</h4>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
