...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-background via-primary/5 to-primary/10 text-foreground overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            {/* Urgent Alert Bar */}
            <div className="inline-flex items-center bg-gradient-to-r from-destructive to-destructive/80 text-destructive-foreground px-6 py-2 rounded-full text-sm font-semibold mb-8 animate-pulse">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-10">
              {[
                ...
                <div key={index} className="flex items-center gap-2 glass rounded-full px-4 py-2">
